      ...
      <div class="p-10 bg-white text-black font-sans max-w-5xl mx-auto border border-slate-200 shadow-sm">
        ...
        <header class="border-b-2 border-slate-900 pb-6 mb-8">
          ...
          <p class="text-sm font-semibold text-slate-600 uppercase">
            Gestión y Crecimiento del Club Privado de Inversión Inmobiliaria  · Versión 1.0 · Marzo 2026
          </p>
        </header>
        ...
        <div class="bg-blue-100 p-4 border border-blue-200 mb-8">
          <p class="text-sm italic text-blue-900 leading-relaxed">
            ...
            Este manual recoge las directrices operativas para que cualquier miembro del equipo pueda replicar el sistema de captación, incorporación y fidelización de forma consistente y escalable.
          </p>
        </div>

        <section class="mb-8">
          <h2 class="text-xl font-bold mb-4 border-b border-slate-300 pb-1 uppercase">1. PRINCIPIO RECTOR: UN SISTEMA DUPLICABLE</h2>
          <p class="mb-4 text-sm leading-relaxed text-slate-800">El objetivo es crear un sistema tan claro y sencillo que cualquier persona pueda ejecutarlo correctamente.</p>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-slate-50 p-4 border border-slate-200">
              <p class="text-xs font-bold mb-2 uppercase text-red-700">❌ Error común a evitar</p>
            ...
            <div class="bg-blue-900 p-4 text-white rounded-sm">
              ...
              <p class="text-sm italic font-medium leading-relaxed">
                "Un prescriptor bien formado no convence: abre la puerta. El sistema hace el resto."
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="mb-8">
          ...
          <table class="w-full text-left text-xs border-collapse border border-slate-300">
            <thead>
              <tr class="bg-blue-900 text-white uppercase">
                <th class="p-3 border border-slate-300">Fase</th>
          ...
          <div class="mt-2 bg-blue-100 p-2 text-[10px] text-blue-900 border border-blue-200 font-bold uppercase italic">
            ⚠️ ATENCIÓN: El prescriptor asiste al webinar junto con su invitado para garantizar coherencia.
          </div>
        </section>
        ...
        <section class="mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <ul class="text-sm list-decimal pl-5 space-y-2 text-slate-800 font-medium italic">
              <li>Inscripción en la página web.</li>
              <li>Acceso y completado del onboarding completo.</li>
              <li>Recepción de email de bienvenida.</li>
              <li>Entrada en secuencia de emails de seguimiento.</li>
            </ul>
            <div class="bg-blue-50 p-4 border border-blue-200 flex items-center italic">
              <p class="text-xs text-blue-900 font-medium">
                <strong>🎯 OBJETIVO:</strong> Que cada nuevo miembro sienta que hay un sistema que le acompaña, manteniéndole enfocado y motivado.
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
            <div class="bg-blue-900 text-white p-4">
              <h4 class="font-bold mb-2 uppercase border-b border-blue-700 pb-1">🏠 WEBINAR A — Profesionales</h4>
              <p class="text-blue-100">Perfil: Agentes, gestores, promotores. Contenido: Plataforma, producción e inversión.</p>
            </div>
            <div class="bg-blue-900 text-white p-4">
              <h4 class="font-bold mb-2 uppercase border-b border-blue-700 pb-1">💰 WEBINAR B — Inversores</h4>
        ...
        <section class="mb-8 text-sm">
          ...
          <table class="w-full text-left text-xs border-collapse border border-slate-300 mb-2">
            <thead class="bg-slate-100 text-slate-600 uppercase text-[10px] tracking-widest">
              <tr><th class="p-2 border border-slate-300">Email</th><th class="p-2 border border-slate-300">Envío</th><th class="p-2 border border-slate-300">Objetivo</th></tr>
            </thead>
          ...
          <p class="text-[10px] font-bold text-slate-500 uppercase italic">📌 Redactados con IA, revisados por Equipo Tecnico y aprobados por Equipo de Fundadores.</p>
        </section>
        ...
        <section class="mb-8 p-6 border-2 border-blue-900 bg-slate-50">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs italic">
            <ul class="space-y-1 list-disc pl-4 text-slate-800 font-medium leading-relaxed">
              <li>Más rápidas que escribir.</li>
              <li>Capturan tono e intención.</li>
              <li>Procesadas por IA para generar tareas.</li>
              <li>Reducen reuniones innecesarias.</li>
            </ul>
            <div class="bg-blue-900 text-white p-6 font-bold uppercase text-center flex items-center justify-center rounded-sm">
              <p class="text-sm tracking-wide leading-relaxed italic">
                "Cualquier idea o duda debe enviarse primero como nota de audio."
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="mb-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-[11px] italic italic italic italic tracking-widest italic">
            ...
            <div class="p-3 border border-slate-300 bg-slate-50 italic">
              <strong class="block text-blue-900 uppercase italic">EQUIPO TÉCNICO</strong> Redacción y procesamiento de contenidos. 
            </div>
            <div class="p-3 border border-slate-300 bg-slate-50 italic">
        ...
        <section class="pb-6">
          ...
          <div class="grid grid-cols-3 gap-2 h-24 italic italic italic italic tracking-widest italic italic">
            <div class="border border-slate-300 p-2 text-[9px] text-slate-400 uppercase italic font-bold">Valoraciones:</div>
            <div class="border border-slate-300 p-2 text-[9px] text-slate-400 uppercase italic font-bold">Dudas:</div>
            <div class="border border-slate-300 p-2 text-[9px] text-slate-400 uppercase italic font-bold">Sugerencias:</div>
          </div>
        </section>
        ...
        <footer class="text-center pt-6 border-t border-slate-300 text-[9px] text-slate-500 font-bold uppercase italic italic italic tracking-[0.3em] italic">
          Manual de Buenas Prácticas · Club Privado de Inversión Inmobiliaria · v1.0
        </footer>
      </div>
    `;
  }
